...
public class FlashSaleDao {
    ...
    public ReturnObject<FlashsaleNewRetVo> insertFlashsale(FlashSale flashSale) {
        ...
        ReturnObject<FlashsaleNewRetVo> retObj = null;
        try {
            ...
            if (ret == 0) {
                ...
                flashsaleCriteria.andFlashDateEqualTo(flashSale.getFlashDate());
                flashsaleCriteria.andTimeSegIdEqualTo(flashSale.getTimeSeq());
                Byte type = 2;
